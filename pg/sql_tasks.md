...
## Цель
Оценить практические навыки написания сложных SQL-запросов, построения отчетных выборок, использования аналитических функций, подзапросов, CTE, JOIN, VIEW и оптимизации запросов.
...
2.1. Для каждого заказа в `SELECT` вывести суммарный объем отгрузки (подзапросом).  
2.2. Найти заказы, у которых суммарный объём отгрузок **меньше среднего** по всем заказам.  
2.3. (Коррелированный подзапрос) Найти заказы, у которых объём отгрузок меньше, чем **средний объем отгрузки по тому же продукту**.

---

## 3. Агрегации + HAVING

3.1. Определить продукты, у которых суммарный объем заказов > 150.  
